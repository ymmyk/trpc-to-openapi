...
describe('generator', () => {
  ...
  test('with date transform procedures', () => {
    const appRouter = t.router({
      createUser: t.procedure
        ...
        .input(
          z.object({
            name: z.string(),
            date: z.date().openapi({ description: 'The date the user was created' }),
          }),
        )
        .output(z.date().openapi({ description: 'The date the user was created' }))
        .mutation(({ input }) => input.date),
    });

    const openApiDocument = generateOpenApiDocument(appRouter, {
      ...defaultDocOpts,
      transformers: {
        dateRequest: ({ _def: { openapi } }) =>
          z
            .number()
            ...
            .openapi({
              ...
              description: openapi?.description
                ? `${openapi.description} as a unix timestamp`
                : 'A unix timestamp',
              example: 1690000000000,
            }),
        dateResponse: (s) =>
          s
            .transform((x) => x.getTime())
            .openapi({
              ...s._def.openapi,
              type: 'number',
              description: s._def.openapi?.description
                ? `${s._def.openapi.description} as a unix timestamp`
                : 'A unix timestamp',
              example: 1690000000000,
            }),
      },
    ...
    expect(openApiDocument.paths!['/users']!.post!.requestBody).toMatchInlineSnapshot(`
      Object {
        "content": Object {
          "application/json": Object {
            "schema": Object {
    ...
    `);
    expect(openApiDocument.paths!['/users']!.post!.responses[200]).toMatchInlineSnapshot(`
      Object {
        "content": Object {
          "application/json": Object {
            "schema": Object {
